...
export function getMiner(pickaxe) {
  ...
  return [
    ...
    /* R19 */ [_, _, _, _, _, _, _, _, OL, BH, BY, BY, BY, BY, BY, BY, BY, BY, BY, BY, BH, OL, _, _, _, _, _, _, _, _, _, _],
    /* R20 */ [_, _, _, _, _, _, _, _, OL, BY, BY, BY, BY, BY, BY, BY, BY, BY, BY, BY, BY, OL, _, _, _, _, _, _, _, _, _, _],
    /* R21 */ [_, _, _, _, _, _, _, _, _, OL, BL, BL, BL, BC, BC, BC, BC, BL, BL, BL, OL, _, _, _, _, _, _, _, _, _, _, _],
    /* R22 */ [_, _, _, _, _, _, _, _, _, OL, BD, BY, BY, BY, BY, BY, BY, BY, BY, BD, OL, _, _, _, _, _, _, _, _, _, _, _],
